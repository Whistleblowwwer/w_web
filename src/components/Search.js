              ...
              <div className="w-full">
                ...
                <div className={`mt-6 p-6 w-[100%] h-auto bg-[#FFF] rounded-[10px] ${darkMode ? 'dark-register-bg' : ''} post-post`}>
                  ...
                  <div className='mt-6 flex w-[100%] post-search'>
                    ...
                    <div>
                      <button className={`ml-[620%] w-[73px] h-[29px] bg-gray-500 rounded-2xl mr-3`}><span className={`flex items-center justify-center text-white text-xs font-medium leading-[11.17px] ${darkMode ? 'dark-text' : ''}`}><i className="fa-solid fa-user"></i></span></button>
                    </div>
                  </div>
                  ...
                  <div className='mt-6 flex w-[100%] post-search'>
                    ...
                    <div>
                      <button className={`ml-[620%] w-[73px] h-[29px] bg-neutral-900 rounded-2xl mr-3 ${darkMode ? 'dark-button' : ''}`}><span className={`flex items-center justify-center text-white text-xs font-medium leading-[11.17px] ${darkMode ? 'dark-text' : ''}`}><i className="fa-solid fa-user-plus"></i></span></button>
                    </div>
                  </div>
                  <p className={`mt-2 ml-10 w-[100%] ${darkMode ? 'dark-text-white' : ''} search-txt`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Nunc ultrices est in lectus laoreet, interdum sodales ex posuere.
