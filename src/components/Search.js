          ...
          <div className='w-[190%] mt-6 post-empresa'>
            <div className='flex w-[100%]'>
              <div className='w-full'>
                ...
                >
                  <i className={`ml-4 fa-solid fa-magnifying-glass ${darkMode ? 'dark-text-white' : ''}`} />
                ...
                <div className={`mt-6 p-6 w-[100%] h-auto bg-[#FFF] rounded-[10px] ${darkMode ? 'dark-register-bg' : ''} post-post`}>
                  ...
                  <div className='mt-6 flex w-[100%] post-search'>
                    ...
                    <div>
                      <p className={`ml-2 text-neutral-900 text-base font-bold ${darkMode ? 'dark-text-white' : ''}`}>
                        Ximena
                        <br />
                        <span
                          style={{
                    ...
                    <div>
                      <button className={`ml-[620%] w-[73px] h-[29px] bg-gray-500 rounded-2xl mr-3`}>
                        <span
                  ...
                  <p className={`mt-2 ml-10 w-[100%] ${darkMode ? 'dark-text-white' : ''} search-txt`}>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc ultrices est in lectus laoreet, interdum sodales ex
                  ...
                  <div className='mt-6 flex w-[100%] post-search'>
                    ...
                    <div>
                      <button className={`ml-[620%] w-[73px] h-[29px] bg-neutral-900 rounded-2xl mr-3 ${darkMode ? 'dark-button' : ''}`}>
                        <span
                          className={`flex items-center justify-center text-white text-xs font-medium leading-[11.17px] ${
                            darkMode ? 'dark-text' : ''
                          }`}
              ...
              <div className='flex flex-col ml-6 mr-3 respohidden'>
                <div className={`w-[150%] h-[auto] bg-[#FFF] border ${darkMode ? 'dark-register-bg' : ''}`}>
                  <div className='flex mt-5 mb-1 justify-between'>
                    ...
                    <i className={`fa-solid fa-sliders mr-8 ${darkMode ? 'dark-text-white' : ''}`}></i>
                  </div>
                  <div className={`ml-5 mt-6 w-[232px] h-[0px] border border-neutral-900 ${darkMode ? 'dark-border-white' : ''}`}></div>
                  <h1 className={`mt-5 ml-5 mb-3 text-neutral-900 text-lg font-bold leading-none ${darkMode ? 'dark-text-white' : ''}`}>
                    About
                  </h1>
