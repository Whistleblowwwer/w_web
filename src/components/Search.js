                    ...
                    <div className="w-[190%] mt-6 post-empresa">
                        <div className="flex w-[100%]">
                            <div className="w-full">
                                ...
                                >
                                    <i
                                        className={`ml-4 fa-solid fa-magnifying-glass ${
                                            darkMode ? "dark-text-white" : ""
                                        }`}
                                    />
                              ...
                              ${
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        adipiscing elit. Nunc ultrices est in
                                        lectus laoreet, interdum sodales ex
                                        posuere. Aliquam molestie auctor tortor
                                        ut pharetra.
                                    </p>
                            ...
                            <div className="flex flex-col ml-6 mr-3 respohidden">
                                ...
                                >
                                    <div className="flex mt-5 mb-1 justify-between">
                                        ...
                                        <i
                                            className={`fa-solid fa-sliders mr-8 ${
                                                darkMode
                                                    ? "dark-text-white"
                                                    : ""
                                            }`}
