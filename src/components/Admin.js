            ...
            <div className={`flex justify-center items-center h-screen ${darkMode ? 'dark-register-bg' : ''}`}>
                ...
                <div className="contain-principal-begin flex ml-[12%]">
                    ...
                    <div className="w-1/2 p-4 flex flex-col contain-principal-begin">
                        ...
                        <p className={`text-neutral-900 text-[12px] font-medium mt-4 ${darkMode ? 'dark-text-white' : ''}`}>Al registrarte, aceptas los <span className="underline">Términos de legales</span> y la <span className="underline">Política
