                    ...
                    <div className="w-[100%] mt-6">
                        {activeButtonCon === "tucuen" && (
                            <div className="w-[100%] mt-6">
                                ...
                                >
                                    Ve la información de la cuenta, descarga un
                                    archivo con tus datos u obtén más
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p className="ml-1 text-[12px] font-medium leading-[10.71px]">
                                            Ve la información de tu cuenta, como
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p className="ml-1 text-[12px] font-medium leading-[10.71px]">
                                            Cambia tu contraseña en cualquier
                                            momento.
                                        </p>
                                    </button>
                                </div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p className="ml-1 text-[12px] font-medium leading-[10.71px]">
                                            Averigua cómo puedes eliminar tu
                                            cuenta
                                        </p>
                                    </button>
                                </div>
