        ...
        <div className='contain-principal'>
          <div className='w-[60%] mt-6 ml-[40px] sidebar1'>
            ...
            <div className={`margin-top mt-3 ${darkMode ? 'dark-text-white' : ''} sidebarcontain`}>
              ...
              >
                <p className='ml-4 p-txt'>
                  <i className='p-fa fa-solid fa-message mr-3'></i>
                  Mensajes
                </p>
              </button>
            </div>
            <div className={`margin-top mt-3 ${darkMode ? 'dark-text-white' : ''} sidebarcontain`}>
              <button
                className={activeButton === 'settings' ? (darkMode ? 'active-buttonH font-bold' : 'active-buttonD font-bold') : ''}
                onClick={() => {
              ...
              >
                <p className='ml-4 p-txt'>
                  <i className='p-fa fa-solid fa-gear mr-3'></i>
                  Configuracion
                </p>
              </button>
            </div>
          ...
          <div className='w-[60%] mt-6'>
            ...
            <div className={`margin-top mt-3 ${darkMode ? 'dark-text-white' : ''} sidebarcontain`}>
              <button
                className={activeButtonCon === 'tucuen' ? (darkMode ? 'active-buttonH font-bold' : 'active-buttonD font-bold') : ''}
                onClick={() => {
            ...
            <div className={`margin-top mt-3 ${darkMode ? 'dark-text-white' : ''} sidebarcontain`}>
              <button
                className={activeButtonCon === 'seguridad' ? (darkMode ? 'active-buttonH font-bold' : 'active-buttonD font-bold') : ''}
                onClick={() => {
            ...
            <div className={`margin-top mt-3 ${darkMode ? 'dark-text-white' : ''} sidebarcontain`}>
              <button
                className={activeButtonCon === 'privacidad' ? (darkMode ? 'active-buttonH font-bold' : 'active-buttonD font-bold') : ''}
                onClick={() => {
            ...
            <div className={`margin-top mt-3 ${darkMode ? 'dark-text-white' : ''} sidebarcontain`}>
              <button
                className={activeButtonCon === 'notificaciones' ? (darkMode ? 'active-buttonH font-bold' : 'active-buttonD font-bold') : ''}
                onClick={() => {
            ...
            <div className={`margin-top mt-3 ${darkMode ? 'dark-text-white' : ''} sidebarcontain`}>
              <button
                className={activeButtonCon === 'acceses' ? (darkMode ? 'active-buttonH font-bold' : 'active-buttonD font-bold') : ''}
                onClick={() => {
          ...
          <div className='w-[100%] mt-6'>
            {activeButtonCon === 'tucuen' && (
              <div className='w-[100%] mt-6'>
                ...
                <p className={`mt-4 w-[80%] text-[14px] font-medium leading-[10.71px] ${darkMode ? 'dark-text-white' : ''}`}>
                  Ve la información de la cuenta, descarga un archivo con tus datos u obtén más información acerca de las opciones de
                    ...
                    {darkMode ? (
                      <>
                        <p className='text-white'>
                          Desactivar Dark Mode <i className='fa-solid fa-moon text-white'></i>
                        </p>
                      </>
                    ) : (
                      <>
                        <p className='text-neutral-900'>
                          Activar Dark Mode <i className='fa-regular fa-moon'></i>
                        </p>
                      </>
                    )}
                  </button>
