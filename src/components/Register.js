      ...
      <div className={`flex justify-center items-center h-screen w-screen ${darkMode ? 'dark-register-bg' : ''}`}>
        <div className={`w-[438px] h-[504px] bg-[#FBFCF8] rounded-[10px] ${darkMode ? 'dark-register' : ''}`}>
          <div className='flex justify-between items-center'>
            ...
            <button className={`mr-4 mb-3 ${darkMode ? 'dark-text-white' : ''}`}>
          ...
          <form onSubmit={onSubmitForm}>
            ...
            <div className='flex justify-center items-center mt-5 text-neutral-900 text-opacity-60 text-xs font-semibold leading-[11.17px] mr-1 mt-[3px]'>
              ...
              >
                ...
                <input type='radio' value='M' name='gender' checked={inputs.gender === 'M'} required onChange={onGenderChange}></input>
              </div>
              <div
                className={`w-[120px] h-8 bg-stone-50 rounded-[10px] mr-3 flex justify-around items-center ${
                  darkMode ? 'dark-register-bt placeholder-black-dk' : ''
              ...
              >
                ...
                <input type='radio' value='F' name='gender' checked={inputs.gender === 'F'} onChange={onGenderChange} required></input>
              </div>
              <div
                className={`w-[120px] h-8 bg-stone-50 rounded-[10px] mr-3 flex justify-around items-center ${
                  darkMode ? 'dark-register-bt placeholder-black-dk' : ''
              ...
              >
                ...
                <input type='radio' value='C' name='gender' checked={inputs.gender === 'C'} onChange={onGenderChange} required></input>
              </div>
            </div>
            <div className='flex justify-center items-center w-[100%]'>
              ...
              >
                ...
                <span className='underline'>Política de privacidad,</span> incluida la política de{' '}
