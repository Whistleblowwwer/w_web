...
const Profile_user = ({ setAuth }) => {
            ...
            try {
                if (users && users._id_user) {
                    ...
                    const response = await fetch(
                        `http://18.220.124.246:4000/users/reviews?_id_user=${users._id_user}`,
                        requestOptions
                    );
                    ...
                    if (parseRes.reviews) {
                        ...
                        console.warn(
                            "El objeto business no tiene la propiedad 'reviews'"
                        );
                    }
                } else {
                    console.error(
                        "El objeto business no tiene la propiedad _id_user"
                    );
                }
            } catch (err) {
    ...
    const handleComment = () => {
        async function postComment() {
            ...
            try {
                const response = await fetch(
                    "http://18.220.124.246:4000/comments",
                    requestOptions
                );
            } catch (err) {
                console.error(err.message);
                                ...
                                <div className="flex justify-between">
                                    <div className="flex-col">
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            ></i>
                                            <p className="text-center text-[#D9D9D9] text-sm font-semibold">
                                                (0)
                                            </p>
                                        </div>
                                    </div>
            ...
            */}
                                ...
                                >
                                    <div className="flex items-center mt-3">
                                        <img
                                            src={proSet}
                                            alt="Imagen"
                                            className="w-[35px] h-[35px] relative ml-1"
                                        />
                                        <p
                                    ...
                                    <div className="flex mt-6 mb-4">
                                        ...
                                        <p
                                            className={`text-gray-400 text-s font-light leading-normal ml-3 ${
                                                darkMode
                                                    ? "dark-text-white"
                                                    : ""
                                            }`}
                        ...
                        <div className="w-[66%] h-auto post-post">
                            {postes.map((post, index) => (
                                <div
                                    key={index}
                                    className={`bg-[#FFF] h-auto p-3 mt-1 ${
                                        darkMode ? "dark-register-bg" : ""
                                    }`}
                                >
                                    <div className="flex items-center mt-3">
                                    ...
                                    <div className="flex mt-4 mb-4">
                                        ...
                                        <p
                                            className={`ml-4 text-gray-400 text-s font-light leading-normal ${
                                                darkMode
                                                    ? "dark-text-white"
                                                    : ""
                                            }`}
