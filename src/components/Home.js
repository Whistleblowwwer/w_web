    ...
    async function getSearchs() {
      ...
      try {
        const response = await fetch(
          `http://18.220.124.246:4000/business/search?name=${e}&city=&enitty=&country=&address=&state=`,
          requestOptions
        )
                    ...
                    <div className=''>
                      <button
                        style={{
                          ...
                          background: showPublishIcon ? 'linear-gradient(267deg, #8E1DA1 0%, #2D015A 100%)' : '#F8F8FB'
                        }}
                        className={`w-[48px] h-[48px] bg-[#F8F8FB] rounded-full ${darkMode ? 'dark-button' : ''}`}
                      >
                        <i className={`fa-solid fa-arrow-right mt-1 text-[#A9A9A9] text-[22px] ${darkMode ? 'dark-text' : ''}`}></i>
                      </button>
                    </div>
                    <div className=''>
                      <button
                        ...
                        className={`w-[48px] h-[48px] bg-[#F8F8FB] rounded-full ${darkMode ? 'dark-button' : ''}`}
                      >
                        <i className={`fa-solid fa-arrow-right mt-1 text-[#FFF] text-[22px] ${darkMode ? 'dark-text' : ''}`}></i>
                      </button>
                    </div>
                  </div>
                </div>
            ...
            <div className='w-[66%] h-auto post-post'>
              {postes.map((post, index) => (
                <div key={index} className={`bg-[#FFF] h-auto w-[100%] p-3 mt-1 ${darkMode ? 'dark-register-bg' : ''}`}>
                  <button
                    className='w-[102.3%] mt-[-18px] ml-[-13px] bg-[#F5F5F5] h-[50px]'
          ...
          <div className='w-[26%] translate-x-[283%] h-screen flex flex-col fixed bg-[#FFF] p-5'>
            ...
            <div className='flex ml-3 mt-4'>
              ...
              >
                <p
                  className={`${darkMode ? 'dark-text-white' : ''} ${
                    activeTabView === 'parati' ? 'font-bold' : 'font-bold text-opacity-60'
                  } ml-1 mb-2`}
                >
                  Para ti
                </p>
              ...
              >
                <p
                  className={`${darkMode ? 'dark-text-white' : ''} ${
                    activeTabView === 'tendencias' ? 'font-bold' : 'font-bold text-opacity-60'
                  } mb-2`}
                >
                  Tendencias
                </p>
                {activeTabView === 'tendencias' && <div className='tab-indicator' />}
              </button>
              <button
              ...
              >
                <p
                  className={`${darkMode ? 'dark-text-white' : ''} ${
                    activeTabView === 'noticias' ? 'font-bold' : 'font-bold text-opacity-60'
                  } mb-2`}
                >
                  Noticias
                </p>
              ...
              >
                <p
                  className={`${darkMode ? 'dark-text-white' : ''} ${
                    activeTabView === 'empresas' ? 'font-bold' : 'font-bold text-opacity-60'
                  } mb-2`}
                >
                  Empresas
                </p>
