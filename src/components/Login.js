        ...
        <div className={`w-screen flex justify-center items-center h-screen ${darkMode ? 'dark-register-bg' : ''}`}>
          <div className={`w-[438px] h-[504px] bg-[#FBFCF8] rounded-[10px] ${darkMode ? 'dark-register' : ''}`}>
            <div className='flex justify-between items-center'>
              <h1 className={`text-neutral-900 text-3xl font-semibold leading-7 mt-8 ml-8 ${darkMode ? 'dark-text-white' : ''}`}>
                Inicia sesión
              </h1>
              <button onClick={() => handleButtonClick('/register')} className={`mr-4 mb-3 ${darkMode ? 'dark-text-white' : ''}`}>
            ...
            <div className='flex justify-center items-center mt-6'>
              <input
                ...
                placeholder='heytyy'
                className=' mr-4 mt-4 p-2 rounded-[10px] w-[87%] h-8 bg-stone-50 text-neutral-900 text-opacity-60 text-xs font-medium leading-[11.17px] invalid:[&:not(:placeholder-shown):not(:focus)]:border-red-500'
              />
            ...
            <div className='flex mt-2 ml-5'>
              <p className={`text-zinc-900 text-[10px] font-medium leading-[9.31px] ${darkMode ? 'dark-text-white' : ''}`}>
            ...
            <div className='flex justify-center items-center mt-[120px]'>
              ...
              >
                <span className={`text-stone-50 text-[15px] font-medium leading-[13.96px] ${darkMode ? 'dark-text' : ''}`}>
                  Iniciar sesión
                </span>
              </button>
            </div>
