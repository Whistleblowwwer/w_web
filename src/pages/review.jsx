...
import { NewCommentModal, NewPostModal } from "../components";

export default function Review({ setAuth }) {
  //review variables
        ...
        <div className="w-1/5 bg-[#FFF] fixed h-screen">
          <div className="w-[100%] mt-6 ml-[13%] sidebar1">
            ...
            >
              ...
              >
                <p className="ml-4 text-[20px] p-txt">
                  <i className="p-fa fa-regular fa-bell mr-3"></i>Notificaciones
                </p>
              </button>
            </div>
            <div
        ...
        <div className="w-[55%] bg-[#EEEFEF] ml-[20%] pr-[0.5%]">
          ...
          >
            <div className="w-[100%] h-auto pb-3 pl-3 pt-1 pr-3">
              ...
              <div>
                <button
                  className="w-[100%] mt-[-18px] ml-[-13px] bg-[rgba(255, 255, 255, 0.5)] h-[50px]"
              ...
              <div>
                ...
                <div className="flex items-center mt-7 ml-[1%]">
                  ...
                  <img
                    ...
                    style={{ height: "25px", width: "25px" }}
                    className="mr-2"
                    onClick={() => handleCommentClick(review._id_review)}
                  />
          ...
          <div className="w-[100%] h-auto">
            <input
              className="input-style w-full h-auto"
              placeholder="Escribe un comentario"
              onChange={handleTextChange2Come}
              value={textComment}
            ></input>
                ...
                <div onClick={() => handleReview(post)}>
                  ...
                  <div className="flex items-center mt-7 ml-[1%]">
                    ...
                    <img
                      ...
                      style={{ height: "25px", width: "25px" }}
                      className="mr-2"
                      onClick={() => handleCommentClick(post._id_comment)}
                    />
                    <img src={Share} alt="share" />
                  </div>
                  <div className="flex mt-4 mb-4">
