    ...
    async function getName() {
      ...
      try {
        const response = await fetch(
          "http://18.220.124.246:4000/users",
          requestOptions
        );
        ...
        <div className="contain-principal">
          <div className="w-[100%] mt-6 ml-[40px] sidebar1">
            ...
            >
              ...
              >
                <p className="ml-4 p-txt">
                  <i className="fa-solid fa-message mr-3"></i>Mensajes
                </p>
              </button>
            </div>
          </div>
          <div className="w-[190%] mt-6 post-empresa">
            <div className="flex w-[100%]">
              <div className="w-full">
                <div
                  className={`flex items-center rounded-[33.50px] w-[100%] h-[56px] bg-[#FFF] ${
                    darkMode ? "dark-register-bg" : ""
                  } post-post`}
                >
                  <i
                    class={`ml-4 fa-solid fa-magnifying-glass ${
                      darkMode ? "dark-text-white" : ""
                    }`}
                  />
                  <div className="ml-2 relative w-full">
                    <input
                      ...
                      className={`placeholder-black p-2 w-[96%] h-[34px] bg-zinc-100 rounded-[5px] 
                              ${
                                darkMode
                                  ? "dark-login-bg placeholder-black-p"
                                  : ""
                              }`}
                ...
                <div
                  className={`mt-6 p-6 w-[100%] h-auto bg-[#FFF] rounded-[10px] ${
                    darkMode ? "dark-register-bg" : ""
                  } post-post`}
                >
                  <h1
                  ...
                  <div className="mt-6 flex w-[100%] post-search">
                    ...
                    <div>
                      <p
                        className={`ml-2 text-neutral-900 text-base font-bold ${
                          darkMode ? "dark-text-white" : ""
                        }`}
                      >
                        Ximena
                    ...
                    <div>
                      <button
                        className={`ml-[620%] w-[73px] h-[29px] bg-gray-500 rounded-2xl mr-3`}
                      >
                        <span
                          className={`flex items-center justify-center text-white text-xs font-medium leading-[11.17px] ${
                            darkMode ? "dark-text" : ""
                          }`}
                        >
                  ...
                  <p
                    className={`mt-2 ml-10 w-[100%] ${
                      darkMode ? "dark-text-white" : ""
                    } search-txt`}
                  >
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Nunc ultrices est in lectus laoreet, interdum sodales ex
                    posuere. Aliquam molestie auctor tortor ut pharetra.
                  </p>
                  ...
                  <div className="mt-6 flex w-[100%] post-search">
                    ...
                    <div>
                      <button
                        className={`ml-[620%] w-[73px] h-[29px] bg-neutral-900 rounded-2xl mr-3 ${
              ...
              <div className="flex flex-col ml-6 mr-3 respohidden">
                <div
                  className={`w-[150%] h-[auto] bg-[#FFF] border ${
                    darkMode ? "dark-register-bg" : ""
                  }`}
                >
                  <div className="flex mt-5 mb-1 justify-between">
                    <h1
                      className={`ml-5 text-neutral-900 text-lg font-bold leading-none ${
                        darkMode ? "dark-text-white" : ""
                      }`}
                    >
                      Filtros
                    ...
                    <i
                      class={`fa-solid fa-sliders mr-8 ${
                        darkMode ? "dark-text-white" : ""
                      }`}
                    ></i>
                  </div>
                  <div
                    className={`ml-5 mt-6 w-[232px] h-[0px] border border-neutral-900 ${
                      darkMode ? "dark-border-white" : ""
                    }`}
                  ></div>
                  <h1
                    className={`mt-5 ml-5 mb-3 text-neutral-900 text-lg font-bold leading-none ${
                      darkMode ? "dark-text-white" : ""
                    }`}
                  >
                    About
                  ...
                  <div className="flex justify-between">
                    <p
                      className={`ml-5 w-[230px] text-neutral-900 text-[15px] font-normal leading-[13.96px] ${
                        darkMode ? "dark-text-white" : ""
                      }`}
                    >
                      Cualquiera
